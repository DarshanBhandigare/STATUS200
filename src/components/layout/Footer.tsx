        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs">
              <li>
                <a href="#features" className="hover:text-slate-900 dark:hover:text-slate-200 transition-colors">
                  Features
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#templates" className="hover:text-slate-900 dark:hover:text-slate-200 transition-colors">
                  Templates
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs">
              ...
              <li>
                <span className="text-slate-400 dark:text-slate-500 italic">More templates coming soon</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs">
              ...
              <li>
                <Link to="/signup" className="hover:text-slate-900 dark:hover:text-slate-200 transition-colors">
                  Create Account
                </Link>
              </li>
              <li>
