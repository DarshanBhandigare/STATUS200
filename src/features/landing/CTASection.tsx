  ...
  return (
    <section className="py-20 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-xs text-emerald-600 dark:text-emerald-400 shadow-sm">
        ...
        <div className="pt-4 flex items-center justify-center gap-2 text-xs text-slate-500 dark:text-slate-500">
